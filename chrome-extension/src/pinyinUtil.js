...
const pinyin_dict_withtone = null;
const pinyin_dict_polyphone = null;
const pinyin_dict_firstletter = null;
	...
	parseDict: function()
	{
		...
		if(pinyin_dict_withtone)
		{
			...
			else
			{
				...
				let notone = pinyinUtil.removeTone(pinyin_dict_withtone).split(',');
				let py2hz = {}, py, hz;
...
{
	let poly = pinyin_dict_polyphone;
